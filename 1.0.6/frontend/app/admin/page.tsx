      ...
      <div className="grid gap-4 xl:grid-cols-[0.98fr_1.02fr]">
        ...
        >
          <div className="space-y-4">
            ...
            />
            <label className="block rounded-lg border border-dashed border-[color:var(--line)] bg-[color:var(--surface-soft)] px-4 py-5 text-sm text-[color:var(--text-muted)]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <label className="flex items-center gap-3 rounded-lg border border-[color:var(--line)] bg-[color:var(--surface-soft)] px-4 py-3 text-sm">
            ...
            <button
              ...
              className="btn-primary inline-flex h-12 items-center gap-2 rounded-lg px-5 text-sm font-semibold transition disabled:opacity-60"
            >
            ...
            {uploadResult ? (
              <div className="rounded-lg border border-[color:var(--line)] bg-[color:var(--surface-soft)] p-4 text-sm">
        ...
        <AppCard title="Tài liệu thủ công gần đây" subtitle="Kiểm tra nhanh tài liệu admin đã nạp vào knowledge base và vector search.">
          <div className="space-y-3">
            ...
            {!manualDocs.length ? (
              <div className="rounded-lg border border-dashed border-[color:var(--line)] bg-[color:var(--surface-soft)] p-4 text-sm text-[color:var(--text-muted)]">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
          ...
          action={
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-[color:var(--line)] bg-[color:var(--surface)] px-4 py-2 text-sm font-semibold text-[color:var(--text-primary)] transition hover:bg-[color:var(--surface-soft)]"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[color:var(--accent)] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[color:var(--accent-strong)]"
              >
                <RefreshCcw className="h-4 w-4" />
                Reindex
              </button>
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="rounded-md border border-[color:var(--line)] bg-[color:var(--surface)] px-3 py-2 text-xs text-[color:var(--text-primary)] transition hover:bg-[color:var(--accent-soft)]"
                    >
                      Bật/Tắt
                    </button>
                    <button
                      ...
                      className="rounded-md bg-[color:var(--accent)] px-3 py-2 text-xs font-semibold text-white transition hover:bg-[color:var(--accent-strong)]"
                    >
                      Crawl lại
                    </button>
                  </div>
        ...
        <AppCard title="Prompt hệ thống" subtitle="Điều chỉnh giọng điệu trả lời để bám ngữ cảnh sinh viên UIT và phân biệt rõ nguồn chính thức.">
          <textarea
            ...
            className="min-h-[220px] w-full rounded-lg border border-[color:var(--line)] bg-[color:var(--surface-soft)] px-4 py-3 text-sm leading-6 outline-none"
          />
          <button
            type="button"
            onClick={async () => {
            ...
            className="mt-4 rounded-lg bg-[color:var(--accent)] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[color:var(--accent-strong)]"
          >
            Lưu prompt
          </button>

          <div className="mt-4 rounded-lg border border-[color:var(--line)] bg-[color:var(--surface-soft)] p-4">
            <p className="text-sm font-medium">Cấu hình hiện có</p>
            <div className="mt-3 space-y-2">
              {configs.map((item) => (
                <div key={String(item.id)} className="rounded-lg bg-[color:var(--surface)] px-3 py-2 text-sm text-[color:var(--text-muted)]">
                  {String(item.key)}
                </div>
              ))}
            </div>
          ...
          {logs.map((item) => {
            ...
            return (
              <div key={String(item.id)} className="rounded-lg border border-[color:var(--line)] bg-[color:var(--surface-soft)] p-4">
                ...
                {detail ? (
                  <div className="mt-3 rounded-md bg-[color:var(--surface)] p-3 text-xs text-[color:var(--text-muted)]">
