...
export default function SearchPage() {
  ...
  return (
    ...
    >
      {/* Thanh tab pill */}
      <div className="flex flex-wrap gap-2 rounded-lg border border-[color:var(--line)] bg-[color:var(--surface-soft)] p-2">
        {TABS.map((tab) => (
          <button
            key={tab.id}
            type="button"
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              ...
              {taiLieuDocs.map((item) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-lg border border-[color:var(--line)] bg-[color:var(--surface)] p-5 shadow-sm transition hover:border-[color:var(--accent)]/30"
                >
