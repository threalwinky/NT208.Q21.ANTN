      ...
      <div className="grid gap-4 xl:grid-cols-[0.75fr_1.25fr]">
        <AppCard title="Tóm tắt" subtitle="Studify chỉ dùng hồ sơ này để cá nhân hóa trải nghiệm trong app.">
          <div className="space-y-4">
            ...
            {message ? <p className="rounded-lg bg-[color:var(--accent-soft)] px-4 py-3 text-sm text-[color:var(--accent)]">{message}</p> : null}
          </div>
        </AppCard>
        ...
        <AppCard title="Cập nhật hồ sơ" subtitle="Các trường học vụ có thể chỉnh để demo đúng ngành/lớp của sinh viên.">
          ...
          <button type="button" onClick={save} className="btn-primary mt-5 rounded-lg px-5 py-3 text-sm font-semibold transition">
            Lưu hồ sơ
          </button>
        </AppCard>
      </div>
