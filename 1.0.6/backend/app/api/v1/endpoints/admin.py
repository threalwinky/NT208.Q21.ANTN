...
# Giới hạn dung lượng tải lên để tránh nạp file quá lớn vào RAM (DoS bộ nhớ).
...
async def upload_document(
    ...
    # Ghi file theo từng chunk và chặn nếu vượt quá giới hạn dung lượng.
    total_bytes = 0
    try:
        ...
        raise
    except Exception as exc:  # dọn file dở nếu ghi lỗi
        stored_path.unlink(missing_ok=True)
