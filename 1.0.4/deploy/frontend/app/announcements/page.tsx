    ...
    >
      <AppCard title="Thông báo mới nhất" subtitle="Có thể lưu lại để đọc sau khi bạn đang bận học hoặc bận deadline.">
        <div className="grid gap-4 xl:grid-cols-2">
          {items.map((item) => (
            <div key={String(item.id)} className="rounded-[24px] border border-[color:var(--line)] bg-[color:var(--surface-soft)] p-5">
              ...
              <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-stretch gap-2">
                  <button
                    ...
                    className="btn-secondary inline-flex h-11 min-w-[116px] items-center gap-2 rounded-2xl px-4 text-sm font-medium transition"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="btn-primary inline-flex h-11 min-w-[116px] rounded-2xl px-4 text-sm font-semibold transition"
                  >
                    Mở nguồn
                  </a>
                </div>
