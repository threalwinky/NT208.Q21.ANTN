...
def next_occurrence(
    ...
    *,
    ...
    anchor = now.astimezone(timezone.utc).replace(second=0, microsecond=0)
    days_ahead = (weekday - anchor.isoweekday()) % 7
...
def seed_student_schedules(db: Session, profile_map: dict[str, StudentProfile], now: datetime) -> None:
    ...
    if vu_profile is not None:
        vu_nt201_start, vu_nt201_end = next_occurrence(now, weekday=2, hour=7, minute=30)
        vu_nt202_start, vu_nt202_end = next_occurrence(now, weekday=4, hour=13, minute=0)
        vu_it002_start, vu_it002_end = next_occurrence(now, weekday=6, hour=10, minute=0)
        vu_exam_nt201_start, vu_exam_nt201_end = next_occurrence(now, weekday=3, hour=13, minute=30, duration_hours=2, week_offset=2)
        vu_exam_nt202_start, vu_exam_nt202_end = next_occurrence(now, weekday=5, hour=7, minute=30, duration_hours=2, week_offset=3)
        ...
        replace_student_schedule(
            ...
            class_items=[
                {
                    "course_code": "NT201",
                    "course_name": "Định tuyến và chuyển mạch",
                    "lecturer_name": "ThS. Nguyễn Trọng Nhân",
                    "room_name": "C205",
                    "weekday": 2,
                    "period_start": 1,
                    "period_end": 3,
                    "starts_at": vu_nt201_start,
                    "ends_at": vu_nt201_end,
                    "display_color": "#2563EB",
                },
                {
                    "course_code": "NT202",
                    "course_name": "Quản trị hệ thống Linux",
                    "lecturer_name": "ThS. Trần Minh Khoa",
                    "room_name": "E401",
                    "weekday": 4,
                    "period_start": 7,
                    "period_end": 9,
                    "starts_at": vu_nt202_start,
                    "ends_at": vu_nt202_end,
                    "display_color": "#0F766E",
                },
                {
                    "course_code": "IT002",
                    "course_name": "Lập trình hướng đối tượng",
                    "lecturer_name": "ThS. Võ Quốc Dũng",
                    "room_name": "E302",
                    "weekday": 6,
                    "period_start": 4,
                    "period_end": 6,
                    "starts_at": vu_it002_start,
                    "ends_at": vu_it002_end,
            ...
            exam_items=[
                {
                    ...
                    "room_name": "C309",
                    "exam_type": "Thực hành",
                    "starts_at": vu_exam_nt201_start,
                    "ends_at": vu_exam_nt201_end,
                },
                {
                    "course_code": "NT202",
                    "course_name": "Quản trị hệ thống Linux",
                    "room_name": "E105",
                    "exam_type": "Thực hành",
                    "starts_at": vu_exam_nt202_start,
                    "ends_at": vu_exam_nt202_end,
                },
            ],
        )
