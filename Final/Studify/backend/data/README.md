...
Script này thu thập tài liệu công khai từ các nguồn UIT, lưu snapshot vào `backend/data/`, trích text từ HTML/PDF, và tạo `processed/uit_documents.jsonl` để import vào knowledge base.
