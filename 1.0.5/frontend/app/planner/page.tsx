        ...
        <div className="space-y-5">
            ...
            {activePlan && (
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  disabled={validating}
                  className="ml-auto btn-primary inline-flex h-9 items-center gap-2 rounded-xl px-4 text-sm font-semibold transition disabled:opacity-60"
                >
          ...
          {validation && (
            <AppCard title="Kết quả kiểm tra" subtitle="">
              <div className={`mb-4 flex items-center gap-3 rounded-2xl px-4 py-3 ${validation.valid ? "bg-green-50 dark:bg-green-900/20" : "bg-amber-50 dark:bg-amber-900/20"}`}>
                {validation.valid ? (
                ...
                >
                  <div className="space-y-2">
                    ...
                    {sem.courses.map((course) => (
                      <div key={course.id} className="flex items-center justify-between rounded-xl border border-[color:var(--line)] bg-[color:var(--surface-soft)] px-4 py-3">
                        <div>
                    ...
                    {addingCourse === sem.id ? (
                      <div className="mt-3 space-y-2">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="btn-primary h-9 rounded-xl px-4 text-sm font-medium transition"
                          >
                            Thêm
                          </button>
                          <button
                            ...
                            className="btn-secondary h-9 rounded-xl px-4 text-sm transition"
                          >
                            Huỷ
                          </button>
                        </div>
                      ...
                      <div className="mt-3 flex gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-xl border border-dashed border-[color:var(--line)] px-3 py-2 text-sm text-[color:var(--text-muted)] hover:border-[color:var(--accent)] hover:text-[color:var(--accent)] transition"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-xl px-3 py-2 text-sm text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition"
                        >
                ...
                <AppCard title="Thêm học kỳ mới" subtitle="">
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 rounded-xl border border-[color:var(--line)] bg-[color:var(--surface-soft)] px-3 py-2 text-sm outline-none"
                      placeholder="Ví dụ: HK1 2025-2026"
                    />
                    <button type="button" onClick={handleAddSemester} className="btn-primary h-10 rounded-xl px-4 text-sm font-medium">Thêm</button>
                    <button type="button" onClick={() => setAddingSemester(false)} className="btn-secondary h-10 rounded-xl px-4 text-sm">Huỷ</button>
                  </div>
                </AppCard>
              ) : (
                <button
                  ...
                  className="w-full rounded-2xl border border-dashed border-[color:var(--line)] py-4 text-sm text-[color:var(--text-muted)] hover:border-[color:var(--accent)] hover:text-[color:var(--accent)] transition"
                >
          ...
          {!activePlan && plans.length === 0 && (
            <div className="rounded-[22px] border border-dashed border-[color:var(--line)] bg-[color:var(--surface-soft)] p-8 text-center">
              ...
              <button type="button" onClick={handleCreatePlan} className="btn-primary mt-4 h-10 rounded-xl px-5 text-sm font-medium">
