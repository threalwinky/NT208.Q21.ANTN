...
export function AppCard({
  ...
  return (
    <section className={`rounded-[24px] border border-[color:var(--line)] bg-[color:var(--surface)] p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] ${className}`}>
...
export function StatCard({
  ...
  return (
    <div className="rounded-[20px] border border-[color:var(--line)] bg-[color:var(--surface-soft)] p-5">
