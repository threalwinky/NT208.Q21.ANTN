...
class ChatService:
    ...
    def _direct_answer_rules(self, effective_query: str) -> str:
        ...
        rules = [
            ...
            "Với câu hỏi học vụ, trình bày theo thứ tự: kết luận ngắn trước, chi tiết theo khóa/chương trình sau.",
    ...
    async def _prepare_turn(
        ...
        effective_query = self._build_effective_query(db, session, content)
